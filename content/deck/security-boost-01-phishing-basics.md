...
<!-- .slide: data-background="/images/bg/hook.jpg" data-state="blur" -->
...
---
<!-- .slide: data-background="/images/bg/kahoot.png"  data-state="dim" -->

## Quiz incoming!


___
<!-- .slide: data-background="/images/bg/kahoot.png"  data-state="megadimblur" -->
...
---
<!-- .slide: data-background="/images/bg/hook.jpg"  data-state="dim" -->
...
---
<!-- .slide: data-background="/images/bg/phishing.jpg"  data-state="dimblur" -->
...
___
<!-- .slide: data-background="/images/bg/spearphishing.jpg" data-state="dimblur" -->
...
![Faktura fran Telia](/images/faktura-telia.png)

___
<!-- .slide: data-background="/images/bg/whaling.jpg" data-state="dimblur" -->
...
![Whaling Example](/images/whaling-ex.jpg)
...
<!-- .slide: data-background="/images/bg/mailbox.jpg" data-state="dimblur" -->

Spoofing email is doable

![brendan fake](/images/brendan-fake-mail.png)
...
![friend hacked](/images/phishing-hacked-account.jpg)

attacker doesn't even need to spoof anything

___
<!-- .slide: data-background="/images/bg/magnifying-glass.jpg" data-state="dimblur" -->
...
___
<!-- .slide: data-background="/images/bg/vishing.jpg" data-state="dim"-->
...
![IRS scam](/images/irs-scam.jpg)

___

<!-- .slide: data-background="/images/bg/smishing.jpg" data-state="megadimblur" -->

## Smishing

- Phishing over SMS

![wells faergo smishing](/images/wells-fargo-smishing.jpg)
...
<!-- .slide: data-background="/images/bg/social-networks.jpg" data-state="megadimblur" -->
...
![FB phishing link](/images/fb-phishing-what-are-you-doing-lol.png)
...
___
<!-- .slide: data-background="/images/bg/green-padlock.jpg" data-state="dimblur"-->

## The green padlock

What do you think of those websites?

![Fake https2](/images/fake-https-paypal.jpg)
...
## The green padlock
 ...
 ![Fake https2](/images/fake-https-2.jpg)
...
___
<!-- .slide: data-background="/images/bg/typewriter.jpg" data-state="megadimblur" -->
## Typosquatting
...
![Punycode example](/images/punycode-example.png)
...
___
<!-- .slide: data-background="/images/bg/2fa.jpg" data-state="dimblur" -->
...
---
<!-- .slide: data-background="/images/bg/sleepy-cat.jpg" data-state="dim" -->

## Ok, that's enough for today

---
<!-- .slide: data-background="/images/bg/questions.jpg" data-state="shadow" -->
